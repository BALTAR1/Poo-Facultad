...
def main():
    ...
    while True:
        ...
        if opcion == 1:
            ...
            posicion = int(
                input("Ingrese la posición donde desea insertar el vehículo: ")
            )
            ...
            patente = input(
                "Ingrese la patente del vehículo para modificar el precio base: "
            )
            ...
            if vehiculo:
                ...
                print(
                    f"El nuevo precio de venta es: {vehiculo.calcular_importe_venta_usado()}"
                )
            else:
            ...
            nombre_archivo = input(
                "Ingrese el nombre del archivo donde desea guardar los vehículos: "
            )
