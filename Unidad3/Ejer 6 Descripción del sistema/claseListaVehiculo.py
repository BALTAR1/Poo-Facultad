        ...
        try:
            with open(nombre_archivo, "r") as f:
                ...
                if contenido:
                    ...
                    self.vehiculos = self.diccionarios_a_vehiculos(
                        diccionarios_vehiculos
                    )
                else:
                    print(
                        f"El archivo '{nombre_archivo}' está vacío. Se creará una nueva lista de vehículos."
                    )
                    self.vehiculos = []
        except FileNotFoundError:
            print(
                f"El archivo '{nombre_archivo}' no existe. Se creará una nueva lista de vehículos."
            )
            self.vehiculos = []
