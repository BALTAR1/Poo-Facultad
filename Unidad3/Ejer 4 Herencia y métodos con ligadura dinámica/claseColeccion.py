...
from claseEmpleado_contrato import EmpleadoContratado
...
class ColeccionEmpleados:
    ...
    def total_tarea(self, tarea):
        ...
        for empleado in self.__empleados:
            if (
                isinstance(empleado, EmpleadoExterno)
                and empleado.get_tarea() == tarea
                and not empleado.finalizo_tarea()
            ):
    ...
    def listar_empleados(self):
        ...
        while i < len(self.__empleados):
            ...
            if empleado is not None:
                print(
                    f"DNI: {empleado.get_dni()}, Nombre: {empleado.get_nombre()}, Sueldo: {empleado.calcular_sueldo()}"
                )
            i += 1
    ...
    def obtener_empleado_con_mayor_sueldo(self):
        ...
        while i < len(self.__empleados):
            empleado = self.__empleados[i]
            if (
                empleado_mayor_sueldo is None
                or empleado.calcular_sueldo() > empleado_mayor_sueldo.calcular_sueldo()
            ):
    ...
    def ayuda_economica(self):
        ...
        while i < len(self.__empleados):
            ...
            if empleado.calcular_sueldo() < 150000:
                print(
                    f"Nombre: {empleado.get_nombre()}, Dirección: {empleado.get_direccion()}, DNI: {empleado.get_dni()}"
                )
            i += 1
    ...
    def calcular_sueldo(self):
        ...
        while i < len(self.__empleados):
            empleado = self.__empleados[i]
            print(
                f"Nombre: {empleado.get_nombre()}, Teléfono: {empleado.get_telefono()}, Sueldo: {empleado.calcular_sueldo()}"
            )
            i += 1
